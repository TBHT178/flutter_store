                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('07 Nov 1996', style: Theme.of(context).textTheme.headlineSmall,),
                    ],
                  ),
                ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text('Order', style: Theme.of(context).textTheme.labelMedium!.apply(color: TColors.primary, fontWeightDelta: 1),),
                          Text('[#17aug96]', style: Theme.of(context).textTheme.titleMedium,),
                        ],
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Shipping Date', style: Theme.of(context).textTheme.labelMedium!.apply(color: TColors.primary, fontWeightDelta: 1),),
